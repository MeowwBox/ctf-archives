...
FIRMWARE="${FIRMWARE:-${SCRIPT_DIR}/pitlane-can-gateway-v1.8.3.bin}"
FLAG_VALUE="${FLAG:-CTFAC{local_can_gateway_flag}}"
TMPDIR="$(mktemp -d)"
...
echo "[pitlane_can_gateway] CAN bench protocol will appear on the VM serial stream after PLREADY" >&2
