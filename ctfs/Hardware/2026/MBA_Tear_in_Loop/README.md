...
After noticing that a 4‑digit password (level 1) is not robust, they devised an authentication based on tearing, granting access only to the most technical (level 1) and the most precise users.
